...
| :---: | :--- | --- | --- |
| ✔ | Integração com ```<Servo.h>``` para rotação contínua do Servo Motor. | `Concluido`| <a href=https://github.com/dihgab/ElevadorporVoz/tree/main/Bibliotecas/Servo>Librarie</a> |
...
| ⏳︎ | Integração com ```<VoiceRecognitionV3.h>``` e ```<SoftwareSerial.h>``` para reconhecimento de voz.  | `Andamento`| <a href=https://github.com/dihgab/ElevadorporVoz/tree/main/Bibliotecas/VoiceRecognitionV3-master>Librarie</a> |
