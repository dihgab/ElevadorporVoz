...
| ⏳︎ | Integração com ```<VoiceRecognitionV3.h>``` e ```<SoftwareSerial.h>``` para reconhecimento de voz.  | `Concluído`| <a href=https://github.com/dihgab/ElevadorporVoz/tree/main/Bibliotecas/VoiceRecognitionV3-master>Librarie</a> |
